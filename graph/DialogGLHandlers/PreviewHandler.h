...
#include <afxext.h>
#include "..\DialogGL\DialogGLDoc.h"
#include "..\DialogGL\DialogGLView.h"
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CDialogGLView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CDialogGLDoc, (CObject*) m_pDocument->GetContainer());
