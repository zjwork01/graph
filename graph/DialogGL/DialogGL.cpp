...
BEGIN_MESSAGE_MAP(CDialogGLApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDialogGLApp::OnAppAbout)
...
CDialogGLApp::CDialogGLApp()
{
	...
	SetAppID(_T("DialogGL.AppID.NoVersion"));
...
BOOL CDialogGLApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDialogGLDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CDialogGLView));
	if (!pDocTemplate)
		return FALSE;
